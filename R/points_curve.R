...
#' This function sorts the scores of a model test and generates the points which will be used to plot its the ROC curve
#' @param x It is the vector of the status (gold standar)
#' @param y It is the vector with the values of a predictor variable or clasificator
#' @return return a matrix with the points of 1-specificity and sensibility that will be used to generate a ROC curve
#' @export points_curve
#' @examples
#'library(fission)
#'data("fission")
